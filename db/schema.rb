...
ActiveRecord::Schema.define(version: 2023_09_14_203930) do
  ...
  create_table "spree_orders", id: :serial, force: :cascade do |t|
    ...
    t.decimal "route_insurance_quote_premium", precision: 10, scale: 2, default: "0.0", null: false
  ...
  create_table "spree_products", id: :serial, force: :cascade do |t|
    ...
    t.integer "total_units_sold", default: 0
  ...
  create_table "spree_taxons_users", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "taxon_id"
    t.index ["taxon_id"], name: "index_spree_taxons_users_on_taxon_id"
    t.index ["user_id"], name: "index_spree_taxons_users_on_user_id"
  end
